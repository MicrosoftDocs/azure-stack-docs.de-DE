...
Bei Netzwerkcontrollerbereitstellungen ohne Kerberos müssen Zertifikate bereitgestellt werden. Weitere Informationen finden Sie in den [Schritten nach der Netzwerkcontrollerbereitstellung](/technologies/network-controller/post-deploy-steps-nc.md).