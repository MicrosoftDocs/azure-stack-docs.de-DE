...
Weitere Informationen zur Verwendung von VMM für eine Bare-Metal-Bereitstellung des Betriebssystems finden Sie unter [Bereitstellen eines Hyper-V-Hosts oder -Clusters basierend auf Bare-Metal-Computern](/system-center/vmm/hyper-v-bare-metal?view=sc-vmm-2019).
