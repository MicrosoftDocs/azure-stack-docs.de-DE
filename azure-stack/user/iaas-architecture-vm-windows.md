...
**Datenverschlüsselung:** Azure Stack Hub nutzt BitLocker-128-Bit-AES-Verschlüsselung, um ruhende Benutzer- und Infrastrukturdaten im Speichersubsystem zu schützen. Weitere Informationen finden Sie unter [Verschlüsselung für ruhende Daten in Azure Stack Hub](../operator/azure-stack-security-bitlocker.md).
