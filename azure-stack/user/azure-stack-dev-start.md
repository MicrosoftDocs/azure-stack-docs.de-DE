...
1. Richten Sie PowerShell ein. Weitere Informationen finden Sie unter [Installieren von Azure Stack Hub PowerShell](../operator/powershell-install-az-module.md). 
