...
Folgen Sie den [hier](../operator/azure-stack-csp-ref-operations.md) beschriebenen Anweisungen, um die Mandanten-ID für Ihre Azure Stack-Instanz zu ermitteln. Zum Festlegen Ihrer Umgebungsvariablen führen Sie folgende Vorgänge aus:
...
Bei Verwendung des Azure Stack Development Kit (ASDK) müssen Sie das Zertifizierungsstellen-Stammzertifikat auf Ihrem Remotecomputer als vertrauenswürdig einstufen. Sie müssen das Zertifizierungsstellen-Stammzertifikat nicht für die integrierten Systeme als vertrauenswürdig einstufen.
