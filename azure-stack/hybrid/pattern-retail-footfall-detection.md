...
| Azure Stack Hub | [App Service](../operator/azure-stack-app-service-overview.md) | Der App Service-Ressourcenanbieter stellt eine Basis für Edgekomponenten bereit, u. a. Hosting- und Verwaltungsfeatures für Web-Apps/-APIs und Azure Functions. |
