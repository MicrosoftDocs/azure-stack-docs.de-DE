---
title: 'Versionshinweise für Azure Stack: Sicherheitsupdates für 1908 | Microsoft-Dokumentation'
description: Erfahren Sie mehr über die Sicherheitsupdates aus Update 1908 für Azure Stack.
...
## <a name="1908-update"></a>Update 1908
...
Da Windows-Updates kumulativ sind, enthält dieses Update auch die Sicherheitsnutzlasten für die vorherigen Monate. Diese Liste mit CVEs spiegelt die Sicherheitsnutzlast für Juni, Juli und August 2019 wider.
Weitere Informationen zu diesen Sicherheitsrisiken finden Sie unter den obigen Links oder im Microsoft Knowledge Base-Artikel [4511553](https://support.microsoft.com/help/4511553).
...
## <a name="1905-update"></a>Update 1905

Mit Update 1905 werden die folgenden Sicherheitsupdates installiert:
...
Da Windows-Updates kumulativ sind, enthält dieses Update auch die Sicherheitsnutzlasten für die vorherigen Monate. Diese Liste mit den CVE-Updates spiegelt die Sicherheitsnutzlast für März, April und Mai 2019 wider.
Weitere Informationen zu diesen Sicherheitsrisiken finden Sie unter den obigen Links oder im Microsoft Knowledge Base-Artikel [4499177](https://support.microsoft.com/help/4499177).
::: moniker-end

## <a name="next-steps"></a>Nächste Schritte

- [Überprüfen der Checkliste mit Updateaktivitäten](azure-stack-release-notes-checklist.md)
- [Überprüfen der Liste mit bekannten Problemen](azure-stack-release-notes-known-issues-1908.md)
