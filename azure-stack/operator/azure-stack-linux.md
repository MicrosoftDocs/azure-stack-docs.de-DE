...
Der Azure Linux-Agent (in der Regel **WALinuxAgent** oder **walinuxagent**) ist erforderlich, es können aber nicht alle Versionen des Agents mit Azure Stack verwendet werden. Versionen zwischen 2.2.21 und 2.2.34 (einschließlich) werden in Azure Stack nicht unterstützt. Um die aktuellen Agent-Versionen über 2.2.35 zu verwenden, installieren Sie den Hotfix 1901 bzw. 1902, oder aktualisieren Sie Azure Stack auf die Version 1903 (oder höher). Beachten Sie, dass [cloud-init](https://cloud-init.io/) nur bis Build 1910 in Azure Stack unterstützt wird.
...
[cloud-init](https://cloud-init.io/) wird nur bis Build 1910 in Azure Stack unterstützt. Wenn Sie „cloud-init“ zum Anpassen Ihres virtuellen Linux-Computers verwenden möchten, können Sie die folgenden PowerShell-Anweisungen verwenden: 
...
Laden Sie die Datei in ein Azure Storage-Konto, Azure Stack-Speicherkonto oder GitHub-Repository hoch, das von ihrer Azure Stack-Linux-VM erreichbar ist.
Derzeit wird die Verwendung von „cloud-init“ für die VM-Bereitstellung nur für REST, PowerShell und die CLI unterstützt und verfügt nicht über eine zugehörige Portalbenutzeroberfläche auf Azure Stack.
