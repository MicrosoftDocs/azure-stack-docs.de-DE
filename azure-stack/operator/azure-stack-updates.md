---
title: Verwalten von Updates in Azure Stack Hub | Microsoft-Dokumentation
description: Erfahren Sie, wie Sie Updates in Azure Stack Hub verwalten.
...
1. **Planen des Updates**
    ...
    Bereiten Sie Ihre Azure Stack Hub-Instanz vor, um den Aktualisierungsprozess so reibungslos wie möglich zu gestalten, damit die Benutzer nur minimal beeinträchtigt werden. Informieren Sie Ihre Benutzer über mögliche Dienstausfälle, und befolgen Sie dann die Schritte zum Vorbereiten der Instanz auf das Update. Achten Sie darauf, dass Sie **ALLE** Schritte in der [Azure Stack Hub-Checkliste für Updateaktivitäten](release-notes-checklist.md) ausführen, um sicherzustellen, dass Sie die erforderlichen Schritte zum Anwenden eines Updates abgeschlossen und ein entsprechendes Wartungsfenster für den angewendeten Updatetyp geplant haben.
