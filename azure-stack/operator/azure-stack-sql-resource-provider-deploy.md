...
description: Hier erfahren Sie, wie Sie den SQL Server-Ressourcenanbieter in Azure Stack bereitstellen.
...
> [!IMPORTANT]
> Vor dem Bereitstellen der Version 1.1.47.0 des SQL-Ressourcenanbieters muss das Azure Stack System auf das 1910-Update oder eine höhere Version aktualisiert werden. Version 1.1.47.0 des SQL-Ressourcenanbieter funktioniert unter früheren nicht unterstützten Azure Stack-Versionen nicht.
...
- Stellen Sie sicher, dass die Voraussetzungen der Datencenterintegration erfüllt sind:
    ...
    |Eingangsports für Ressourcenanbieter sind geöffnet.|[Integration des Azure Stack-Datencenters – Veröffentlichen von Endpunkten: Ports und Protokolle (eingehend)](azure-stack-integrate-endpoints.md#ports-and-protocols-inbound)|
...
Wenn Sie die Version 1.1.33.0 oder frühere Versionen des SQL-Ressourcenanbieters bereitstellen, müssen Sie bestimmte Versionen von „AzureRm.BootStrapper“ und Azure Stack-Modulen in PowerShell installieren. Wenn Sie die Version 1.1.47.0 des SQL-Ressourcenanbieters bereitstellen, kann dieser Schritt übersprungen werden.
...
4. Auf der Zusammenfassungsseite der Ressourcengruppenübersicht sollten keine fehlerhaften Bereitstellungen angezeigt werden.
    ...
    ![Überprüfen der Bereitstellung des SQL-Ressourcenanbieters im Azure Stack-Administratorportal](./media/azure-stack-sql-rp-deploy/sqlrp-verify.png)
