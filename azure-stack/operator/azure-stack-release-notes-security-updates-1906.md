---
title: 'Versionshinweise für Azure Stack: Sicherheitsupdates für 1906 | Microsoft-Dokumentation'
description: Erfahren Sie mehr über die Sicherheitsupdates aus Update 1906 für Azure Stack.
...
Da Windows-Updates kumulativ sind, enthält dieses Update auch die Sicherheitsnutzlasten der vorherigen Monate. Die obige Liste mit den CVE-Updates spiegelt die Sicherheitsnutzlast für März, April und Mai 2019 wider.
Weitere Informationen zu diesen Sicherheitsrisiken finden Sie unter den obigen Links oder im Microsoft Knowledge Base-Artikel [4499177](https://support.microsoft.com/en-us/help/4499177).

## <a name="1904-update"></a>Update 1904

Dieses Update von Azure Stack enthält keine Sicherheitsupdates für das zugrunde liegende Betriebssystem, auf dem Azure Stack gehostet wird.

## <a name="1903-update"></a>Update 1903

Dieses Update von Azure Stack enthält keine Sicherheitsupdates für das zugrunde liegende Betriebssystem, das Azure Stack hostet.  

## <a name="1902-update"></a>Update 1902

Das Update 1902 installiert die folgenden Sicherheitsupdates:  
