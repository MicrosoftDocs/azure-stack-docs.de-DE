...
Sollte die aktuelle Version noch nicht installiert sein, lesen Sie [Installieren von PowerShell für Azure Stack Hub](azure-stack-powershell-install.md).
